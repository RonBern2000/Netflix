    ...
    return (
        <Container className="flex-col relative w-19/20 mx-auto">
            ...
            {!scrollPosition.atLeft ? (
                <Button
                    className="absolute flex items-center opacity-0 hover:opacity-100 justify-center left-0  max-sm:h-4/10 sm:h-4/10 md:h-5/10 lg:h-7/10 xl:h-9/10 2xl:h-full w-10 text-white p-2 hover:bg-[#1f1f1fa1] transition z-30"
                    onClick={() => scroll("left")}
                >
                ...
                <Button
                    className="transition-opacity duration-1000 opacity-100 absolute flex items-center justify-center left-0 max-sm:h-4/10 sm:h-4/10 md:h-5/10 lg:h-7/10 xl:h-9/10 2xl:h-full w-10 bg-[#1f1f1fa1] text-white p-2 hover:bg-[#1f1f1fa1]z-30"
            ...
            {!scrollPosition.atRight ? (
                <Button
                    className="absolute opacity-0 hover:opacity-100 flex items-center justify-center right-0 max-sm:h-4/10 sm:h-4/10 md:h-5/10 lg:h-7/10 xl:h-9/10 2xl:h-full w-10  text-white p-2 hover:bg-[#1f1f1fa1] transition z-30"
                ...
                <Button
                    className="transition-opacity duration-1000 opacity-100 absolute flex items-center justify-center right-0 max-sm:h-4/10 sm:h-4/10 md:h-5/10 lg:h-7/10 xl:h-9/10 2xl:h-full w-10 bg-[#1f1f1fa1] text-white p-2 hover:bg-[#1f1f1fa1] z-30"
