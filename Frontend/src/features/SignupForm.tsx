...
const SignupForm = () => {
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Input label={strings.auth.regform.password} containerClassName="w-full mt-2.5" className='w-full border-1 border-gray-400 rounded-sm' {...register("password")} error={errors.password?.message} />
